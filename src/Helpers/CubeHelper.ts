...
import { CellDirectionConfig, CharacterSideConfig, CubeSideAxisConfig, Direction2DVectorConfig, ObjectsRotationBySideConfig, SideVectorConfig } from '../Data/Configs/Cube/SideConfig';
